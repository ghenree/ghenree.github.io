...
// Spoller 
"use strict";const spollersArray=document.querySelectorAll("[data-spollers]");if(0<spollersArray.length){const a=Array.from(spollersArray).filter(function(e,t,s){return!e.dataset.spollers.split(",")[0]});0<a.length&&initSpollers(a);const b=Array.from(spollersArray).filter(function(e,t,s){return e.dataset.spollers.split(",")[0]});if(0<b.length){const i=[];b.forEach(e=>{const t=e.dataset.spollers,s={},o=t.split(",");s.value=o[0],s.type=o[1]?o[1].trim():"max",s.item=e,i.push(s)});let e=i.map(function(e){return"("+e.type+"-width: "+e.value+"px),"+e.value+","+e.type});e=e.filter(function(e,t,s){return s.indexOf(e)===t}),e.forEach(e=>{var e=e.split(","),t=e[1],s=e[2];const o=window.matchMedia(e[0]);var r=i.filter(function(e){if(e.value===t&&e.type===s)return!0});o.addListener(function(){initSpollers(r,o)}),initSpollers(r,o)})}function initSpollers(e,t=!1){e.forEach(e=>{e=t?e.item:e,t.matches||!t?(e.classList.add("sp_init"),initSpollerBody(e),e.addEventListener("click",setSpollerAction)):(e.classList.remove("sp_init"),initSpollerBody(e,!1),e.removeEventListener("click",setSpollerAction))})}function initSpollerBody(e,t=!0){const s=e.querySelectorAll("[data-spoller]");0<s.length&&s.forEach(e=>{t?(e.removeAttribute("tabindex"),e.classList.contains("sp_active")||(e.nextElementSibling.hidden=!0)):(e.setAttribute("tabindex","-1"),e.nextElementSibling.hidden=!1)})}function setSpollerAction(e){const t=e.target;if(t.hasAttribute("data-spoller")||t.closest("[data-spoller]")){const o=t.hasAttribute("data-spoller")?t:t.closest("[data-spoller]"),i=o.closest("[data-spollers]");var s=!!i.hasAttribute("data-akk");i.querySelectorAll("._slide").length||(s&&!o.classList.contains("sp_active")&&hideSpollersBody(i),o.classList.toggle("sp_active"),_slideToggle(o.nextElementSibling,500)),e.preventDefault()}}function hideSpollersBody(e){const t=e.querySelector("[data-spoller].sp_active");t&&(t.classList.remove("sp_active"),_slideUp(t.nextElementSibling,500))}}let _slideUp=(e,t=500)=>{e.classList.contains("_slide")||(e.classList.add("_slide"),e.style.transitionProperty="height, margin, padding",e.style.transitionDuration=t+"ms",e.style.height=e.offsetHeight+"px",e.offsetHeight,e.style.overflow="hidden",e.style.height=0,e.style.paddingTop=0,e.style.paddingBottom=0,e.style.marginTop=0,e.style.marginBottom=0,window.setTimeout(()=>{e.hidden=!0,e.style.removeProperty("height"),e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.removeProperty("margin-top"),e.style.removeProperty("margin-bottom"),e.style.removeProperty("overflow"),e.style.removeProperty("transition-duration"),e.style.removeProperty("transition-property"),e.classList.remove("_slide")},t))},_slideDown=(e,t=500)=>{var s;e.classList.contains("_slide")||(e.classList.add("_slide"),e.hidden&&(e.hidden=!1),s=e.offsetHeight,e.style.overflow="hidden",e.style.height=0,e.style.paddingTop=0,e.style.paddingBottom=0,e.style.marginTop=0,e.style.marginBottom=0,e.offsetHeight,e.style.transitionProperty="height, margin, padding",e.style.transitionDuration=t+"ms",e.style.height=s+"px",e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.removeProperty("margin-top"),e.style.removeProperty("margin-bottom"),window.setTimeout(()=>{e.style.removeProperty("height"),e.style.removeProperty("overflow"),e.style.removeProperty("transition-duration"),e.style.removeProperty("transition-property"),e.classList.remove("_slide")},t))},_slideToggle=(e,t=500)=>(e.hidden?_slideDown:_slideUp)(e,t);
